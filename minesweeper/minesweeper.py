...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        known_mines = neighbours & self.mines
    ...
    def update_knowledge(self):
        ...
        for sentence in self.knowledge:
            if sentence.count == 0:
                new_safe |= sentence.cells

            if len(sentence.cells) == sentence.count:
                new_mine |= sentence.cells
    ...
    def infer_knowledge(self):
            ...
            for sentence2 in self.knowledge:
                ...
                if sentence1.cells.issubset(sentence2.cells):
                    ...
                    if len(inferred_cells) > 0:
                        new_sentences.append(Sentence(inferred_cells, inferred_count))
        ...
        for new_sentence in new_sentences:
         ...
         # Update knowledge again after new inferences
        self.update_knowledge()
        """raise NotImplementedError"""
